        ...
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <Link className="hover:text-gray-400" href="https://x.com/tushar1878926">
                <TwitterIcon className="w-6 h-6" />
              </Link>
              <Link className="hover:text-gray-400" href="https://github.com/tushar-agarwal7">
                <GithubIcon className="w-6 h-6 " />
              </Link>
              <Link className="hover:text-gray-400" href="https://www.linkedin.com/in/tushar-agarwal-469913296/">
